...
def file_ext = "svs"
def json_root_dir = '/mnt/NAS/PDL1-2026-Detections/TNBC-D'

//def model = 'cellpose-sam'
//def model = 'cellpose-sam2'
//def model = 'cellpose-dino'
def model = 'cellpose-dino2'
...
def json_dir_path = buildFilePath(json_root_dir, model, name)
